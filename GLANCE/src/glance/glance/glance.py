...
from ..metrics.feature_bias import compute_feature_type_bias
    ...
    for i, cluster in clusters.items():
        ...
        ret_clusters[i] = {
            ...
            "feature_type_bias": compute_feature_type_bias(
                selected_action, numerical_features_names, categorical_features_names
            ),
        }
...
def print_results(
    ...
    for i, stats in enumerate(clusters_stats.values()):
        ...
        print(f"Feature Biased: {stats['feature_type_bias']:.2%}")
